...
// Lab 3 - Step 4
// 27 January 2022
// This C program is for a TCP server that accepts a client connection and allows for file transfer to the client using threads to handle multiple clients at once
#include <stdio.h>
#include <stdlib.h>
