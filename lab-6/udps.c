...
// Lab 6 - Server
// 11 February 2022
// This C program is for a UDP server that gets file contents as packets from a client. This UDP provides reliable transport service utilizing the stop and wait protocol, which includes checksums, sequence numbers
