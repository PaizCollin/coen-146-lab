...
// Lab 5 - Client
// 4 February 2022
// This C program is for a UDP client that sends a file to a server using packets. This UDP provides reliable transport service utilizing the stop and wait protocol, which includes checksums, sequence numbers
